...
public class DistancesFP {
    ...
    public static void testASHEncodings(String filenameBase, String filenameQueries, String filenameGT) throws IOException {
        ...
        final boolean RUN_FLOAT_SCORING =
                Boolean.parseBoolean(System.getProperty("jvector.bench.float-scoring", "true"));
        ...
        int encodedBits = 776; // (dimension / 4) + HEADER_BITS;
...
//         ForkJoinPool simdExecutor = PhysicalCoreExecutor.pool(); // For production
        ...
        // ==================================================================
        // [3] Float dot-product scoring throughput
        // ==================================================================
        if (RUN_FLOAT_SCORING) {
            ...
            var scoreThroughput = (finalVectorCount * finalQueryCount) / ((floatEnd - floatStart) / 1e9);
    ...
    public static void runDpr10m() throws IOException {
        System.out.println("Running dpr-10m");

        var baseVectors = "./fvec/dpr-10m/c4-en_base_10M_norm_files0_2.fvecs";
        var queryVectors = "./fvec/dpr-10m/c4-en_query_10k_norm_files0_1.fvecs";
        var gtVectors = "./fvec/dpr-10m/c4-en_gt_10M_norm_ip_k100.ivecs";
        testASHEncodings(baseVectors, queryVectors, gtVectors);
    }
