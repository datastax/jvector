...
public abstract class CompressorParameters {
    ...
    public String idStringFor(String name) {
        // only required when supportsCaching() is true
        throw new UnsupportedOperationException();
    }

    public abstract VectorCompressor<?> computeCompressor(RandomAccessVectorValues ravv);
    ...
    public static class PQParameters extends CompressorParameters {
        ...
        @Override
        public String idStringFor(String name) {
            return String.format("PQ_%s_%d_%d_%s_%s", name, m, k, isCentered, anisotropicThreshold);
        }
    ...
    public static class NVQParameters extends CompressorParameters {
        ...
        @Override
        public String idStringFor(String name) {
            return String.format("NVQ_%s_%d_%s", name, nSubVectors);
        }
