...
public class Grid {
                            ...
                            Path testDirectory) throws IOException
    {
        ...
        if (buildCompressor == null) {
            ...
            indexes = buildOnDisk(ravv, ds.similarityFunction, featureSets, M, efConstruction, neighborOverflow, addHierarchy, refineFinalGraph, buildCompressor, testDirectory, graphNamePrefix);
        }
    ...
    protected static Map<Set<FeatureId>, GraphIndex> buildOnDisk(RandomAccessVectorValues ravv,
    ...
    protected static Map<Set<FeatureId>, GraphIndex> buildInMemory(RandomAccessVectorValues ravv,
                                                                   VectorSimilarityFunction similarityFunction,
                                                                   List<? extends Set<FeatureId>> featureSets,
                                                                   int M,
                                                                   int efConstruction,
