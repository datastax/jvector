...
public class Grid {
                                                                        ...
                                                                        ConstructionMetrics constructionMetrics) throws IOException
    {
        ...
        // if our feature set contains Fused PQ, we need a Fused ADC write-time supplier (as we don't have neighbor information during writeFeaturesInline)
        ...
        for (var featureId : features) {
            switch (featureId) {
                ...
                case FUSED_PQ:
                    ...
                    // no supplier as these will be used for writeFeaturesInline, when we don't have enough information to fuse neighbors
