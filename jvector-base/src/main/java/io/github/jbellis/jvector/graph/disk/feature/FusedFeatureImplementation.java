...
// */
//public class FusedFeatureImplementation<Primary extends VectorRepresentation> extends AbstractFeature implements FusedFeature {
...
//
//    public FusedFeatureImplementation(int maxDegree, ProductQuantization pq) {
...
//    }
//
//    static FusedFeatureImplementation load(CommonHeader header, RandomAccessReader reader) {
//        try {
//            return new FusedFeatureImplementation(header.layerInfo.get(0).degree, ProductQuantization.load(reader));
//        } catch (IOException e) {
...
//     * @return
//     */
//    public SimilarityFunction.Approximate approximateScoreFunctionFor(VectorFloat<?> queryVector, VectorSimilarityFunction vsf, OnDiskGraphIndex.View view, SimilarityFunction.Exact esf) {
...
//        if (!(state_ instanceof FusedFeatureImplementation.State)) {
//            throw new IllegalArgumentException("FusedFeatureImplementation.State is not a FusedFeatureImplementation.State");
//        }
//
//        var state = (FusedFeatureImplementation.State) state_;
//
...
//    }
//
//    public static class State<Primary extends VectorRepresentation> implements Feature.State {
//        public final GraphIndexView view;
//        public final IntFunction<ByteSequence<?>> compressedVectorFunction;
//        public final int nodeId;
//
//        public State(GraphIndexView<Primary, Secondary> view, PQVectors pqVectors, int nodeId) {
//            this(view, pqVectors::get, nodeId);
//        }
//
//        public State(GraphIndexView<Primary, Secondary> view, IntFunction<ByteSequence<?>> compressedVectorFunction, int nodeId) {
//            this.view = view;
...
//        var state = (FusedFeatureImplementation.State<Primary>) state_;
