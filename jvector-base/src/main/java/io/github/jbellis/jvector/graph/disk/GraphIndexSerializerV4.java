...
class GraphIndexSerializerV4 extends AbstractGraphIndexSerializer {
    ...
    GraphIndexSerializerV4() {
        this(nonFusedFeatures());
    }

    /**
     * Protected constructor for subclasses (V5, V6) that share V4's wire format but differ
     * in supported features, footer behaviour, or feature ordering.
     */
    protected GraphIndexSerializerV4(Set<FeatureId> supportedFeatures) {
        super(4, supportedFeatures, true, false, FeatureOrdering.BY_FEATURE_ID);
    }
