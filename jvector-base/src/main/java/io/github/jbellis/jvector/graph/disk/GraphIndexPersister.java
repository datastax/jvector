...
/**
 * Fluent builder for persisting a {@link PersistableGraphIndex} to disk. Implements
 * {@link PersistableGraphIndex.WriteBuilder} and wraps the appropriate internal writer strategy
 * based on the graph type and output target.
 * <p>
 * Obtain instances via {@link PersistableGraphIndex#writer(Path)} or
 ...
 */
public class GraphIndexPersister implements PersistableGraphIndex.WriteBuilder {
    ...
    @Override
    public PersistableGraphIndex.WriteBuilder with(Feature feature) {
        features.put(feature.id(), feature);
        return this;
    }

    @Override
    public PersistableGraphIndex.WriteBuilder withMapper(OrdinalMapper mapper) {
        this.mapper = mapper;
        return this;
    }

    @Override
    public PersistableGraphIndex.WriteBuilder withMap(Map<Integer, Integer> oldToNew) {
        return withMapper(new OrdinalMapper.MapMapper(oldToNew));
    }

    @Override
    public PersistableGraphIndex.WriteBuilder withVersion(int version) {
        this.version = version;
        return this;
    }

    @Override
    public PersistableGraphIndex.WriteBuilder withStartOffset(long offset) {
        this.startOffset = offset;
        return this;
    }

    @Override
    public PersistableGraphIndex.WriteBuilder withParallelWorkerThreads(int n) {
    ...
    @Override
    public PersistableGraphIndex.WriteBuilder withParallelDirectBuffers(boolean useDirectBuffers) {
        if (!(graph instanceof OnHeapGraphIndex)) {
    ...
    @Override
    public PersistableGraphIndex.WriteBuilder writeFeaturesInline(int ordinal, Map<FeatureId, Feature.State> stateMap) throws IOException {
    ...
    public void writeHeader(ImmutableGraphIndex.View view) throws IOException {
        ...
        getOrCreateRandomAccessWriter().writeHeader(view);
    }
