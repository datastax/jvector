...
package io.github.jbellis.jvector.index.graph.disk.feature;

import io.github.jbellis.jvector.disk.IndexWriter;
import io.github.jbellis.jvector.disk.RandomAccessReader;
import io.github.jbellis.jvector.index.graph.GraphIndex;
import io.github.jbellis.jvector.index.graph.disk.CommonHeader;
import io.github.jbellis.jvector.index.graph.disk.CompactionContext;
import io.github.jbellis.jvector.index.graph.disk.FusedCompactionStrategy;
import io.github.jbellis.jvector.index.graph.disk.OnDiskGraphIndex;
import io.github.jbellis.jvector.index.graph.disk.PQRetrainer;
import io.github.jbellis.jvector.index.graph.disk.QuantizationCompactionStrategy;
import io.github.jbellis.jvector.index.graph.disk.VectorCompressorRetrainer;
...
public class FusedPQ extends AbstractFeature implements FusedFeature {
    ...
    public VectorCompressor<ByteSequence<?>> getCompressor() {
        return (VectorCompressor<ByteSequence<?>>) (VectorCompressor<?>) pq;
    }
    ...
    public static class State implements Feature.State {
        ...
        public State(GraphIndex.View view, IntFunction<ByteSequence<?>> compressedVectorFunction, int nodeId) {
            this.view = view;
