 ...
 */
public interface MutableRandomAccessVectorRepresentations<Vec extends VectorRepresentation> extends RandomAccessVectorRepresentations<Vec> {
    /**
     * Inserts a vector at the end of the container, increasing its size by one.
