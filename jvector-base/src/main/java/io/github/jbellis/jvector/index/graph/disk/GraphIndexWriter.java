 ...
 * Use {@link #getBuilderFor(GraphIndexWriterTypes, GraphIndex, Path)}
...
public interface GraphIndexWriter extends Closeable {
    ...
    static AbstractGraphIndexWriter.Builder<? extends AbstractGraphIndexWriter<?>, ? extends RandomAccessWriter>
            getBuilderFor(GraphIndexWriterTypes type, GraphIndex graphIndex, Path out) throws FileNotFoundException {
        switch (type) {
            case RANDOM_ACCESS:
    ...
    static AbstractGraphIndexWriter.Builder<? extends AbstractGraphIndexWriter<?>, ? extends IndexWriter>
            getBuilderFor(GraphIndexWriterTypes type, GraphIndex graphIndex, IndexWriter out) {
        switch (type) {
