...
public class TestVectorGraph extends LuceneTestCase {
    ...
    private void testByteVectorBuild(ByteVectorSimilarityFunction bvsf, boolean addHierarchy) {
        ...
        var builder = GraphIndexBuilder.builder(rabvv, bvsf, 8)
                .withBeamWidth(20)
    ...
    public void testByteVectorAddGraphNodeOneByOne() {
        int n = 30, dim = 4;
        var rabvv = randomByteVectorValues(n, dim);
        var builder = GraphIndexBuilder.builder(rabvv, ByteVectorSimilarityFunction.EUCLIDEAN, 4)
                .withBeamWidth(10)
                .withNeighborOverflow(1.2f)
                .withAlpha(1.2f)
                .build();
    ...
    public void testByteVectorBuildViaGenericBuildMethod() {
        int n = 40, dim = 6;
        var rabvv = randomByteVectorValues(n, dim);
        var builder = GraphIndexBuilder.builder(rabvv, ByteVectorSimilarityFunction.DOT_PRODUCT, 6)
                .withBeamWidth(20)
                .withNeighborOverflow(1.2f)
                .withAlpha(1.2f)
                .build();
    ...
    public void testByteVectorSearchRecall() {
        ...
        var builder = GraphIndexBuilder.builder(rabvv, bvsf, 16)
                .withBeamWidth(50)
                .withNeighborOverflow(1.2f)
                .withAlpha(1.2f)
                .build();
