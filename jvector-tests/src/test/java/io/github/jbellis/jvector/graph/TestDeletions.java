...
public class TestDeletions extends LuceneTestCase {
    ...
    public void testMarkDeleted(boolean addHierarchy) {
        ...
        var builder = new GraphIndexBuilder(ravv, VectorSimilarityType.COSINE, 4, 10, 1.0f, 1.0f, addHierarchy);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            var results = GraphSearcher.search(v, 3, ravv, VectorSimilarityType.COSINE, graph, Bits.ALL);
        ...
        var results = GraphSearcher.search(v, ravv.size(), ravv, VectorSimilarityType.COSINE, graph, Bits.ALL);
    ...
    public void testCleanup(boolean addHierarchy) throws IOException {
        ...
        var results = GraphSearcher.search(v, 10, ravv, VectorSimilarityType.COSINE, graph, Bits.ALL);
        ...
        var b2 = new GraphIndexBuilder(ravv, VectorSimilarityType.COSINE, 4, 10, 1.0f, 1.0f, addHierarchy);
    ...
    public void testNoPathToLiveNodesWhenRemovingDeletedNodes2(boolean addHierarchy) throws IOException {
        ...
        try (var builder = new GraphIndexBuilder(ravv, VectorSimilarityType.COSINE, 4, 10, 1.0f, 1.0f, addHierarchy)) {
